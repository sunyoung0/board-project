...
import com.sun.board.dto.response.user.GetSignInUserResponseDto;
...
public class UserController {
	...
	public ResponseEntity<? super PatchUserNicknameResponseDto> patchUserNickname(@AuthenticationPrincipal String email, @RequestBody @Valid PatchUserNicknameRequestDto requestBody) {
	...
	public ResponseEntity<? super PatchUserProfileResponseDto> patchUserProfile(@AuthenticationPrincipal String email, @RequestBody @Valid PatchUserProfileRequestDto requestBody) {
