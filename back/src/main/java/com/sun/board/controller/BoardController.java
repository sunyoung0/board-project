...
public class BoardController {
	...
	public ResponseEntity<?> postComment(@PathVariable("boardNumber") Integer boardNumber){
		return CustomResponse.serviceUnavailable;
	}
	...
	public ResponseEntity<?> patchBoard(@PathVariable("boardNumber") Integer boardNumber) {
		return CustomResponse.serviceUnavailable;
	}

	// API : 게시물 삭제 메서드 //
	@DeleteMapping("/{boardNumber}")
	public ResponseEntity<?> deleteBoard(@PathVariable("boardNumber") Integer boardNumber) {
		return CustomResponse.serviceUnavailable;
	}
}
